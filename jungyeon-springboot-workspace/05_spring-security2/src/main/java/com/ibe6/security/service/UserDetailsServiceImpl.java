package com.ibe6.security.service;

import com.ibe6.security.dto.UserDto;
import com.ibe6.security.dto.auth.LoginUser;
import com.ibe6.security.mapper.UserMapper;
...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        // 조회된 회원이 있을 경우
        // 해당 회원의 최소한의 정보(id, pwd, role)정보 담은 UserDetails 객체를 생성해서 반환
        // 권한목록 세팅
